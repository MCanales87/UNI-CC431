...
GLuint createShaderProgram() {
    ...
    string vertShaderStr = readShaderSource("src/vshader25.glsl");
    string fragShaderStr = readShaderSource("src/fshader25.glsl");
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(600, 600, "program25", NULL, NULL);
