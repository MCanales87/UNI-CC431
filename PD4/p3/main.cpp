...
GLuint globalAmbLoc, ambLoc, diffLoc, specLoc, posLoc1, posLoc2, mambLoc, mdiffLoc, mspecLoc, mshiLoc;
int width, height;
float aspect;
glm::mat4 pMat, vMat, mMat, mvMat, invTrMat, rMat;
glm::vec3 currentLightPos, transformed;
float lightPos1[3];
float lightPos2[3] = {0,2,0};

ImportedModel myModel("dolphinHighPoly.obj");
...
void installLights( glm::mat4 vMatrix ) {
	...
	lightPos1[0] = transformed.x;
	lightPos1[1] = transformed.y;
	lightPos1[2] = transformed.z;
	...
	posLoc1 = glGetUniformLocation(renderingProgram, "light.position1");
	posLoc2 = glGetUniformLocation(renderingProgram, "light.position2");
	...
	glProgramUniform3fv(renderingProgram, posLoc1, 1, lightPos1);
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "PD6 - Prob1", NULL, NULL);
