...
void display(GLFWwindow* window, double currentTime) {
	...
	mMat = glm::rotate(mMat, toRadians(20.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // mMat * Rotate
	//~ mMat = glm::rotate(mMat, toRadians(10.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // T * Rotate * Rotate' * S * vert
	mvpMat = pMat * vMat * mMat;
	
	cout << "VALUES:"<< endl;
	cout << mMat[0][0] << "	" << mMat[0][1] << "	" << mMat[0][2] << "	" << mMat[0][3] << endl;
	cout << mMat[1][0] << "	" << mMat[1][1] << "	" << mMat[1][2] << "	" << mMat[1][3] << endl;
	cout << mMat[2][0] << "	" << mMat[2][1] << "	" << mMat[2][2] << "	" << mMat[2][3] << endl;
	cout << mMat[3][0] << "	" << mMat[3][1] << "	" << mMat[3][2] << "	" << mMat[3][3] << endl;
